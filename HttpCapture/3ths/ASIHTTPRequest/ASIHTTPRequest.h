...
//#import "../../ApexiPhoneOpenAccount1.3.0/ApexiPhoneOpenAccount/Data_Structure.h"
...
//@property (nonatomic) REQUEST_TYPE request_type;
...
//@property (retain, readonly) NSNumber *requestSessionID;
...
//move to public from private by heyy. to remove some warning in project
@property (retain) NSNumber *requestID;
@property (retain) NSNumber *requestSessionID;
