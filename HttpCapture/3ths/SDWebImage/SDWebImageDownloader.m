...
- (id <SDWebImageOperation>)downloadImageWithURL:(NSURL *)url options:(SDWebImageDownloaderOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageDownloaderCompletedBlock)completedBlock {
    ...
    [self addProgressCallback:progressBlock andCompletedBlock:completedBlock forURL:url createCallback:^{
        ...
        NSURL * newURL = url;
        BOOL isGLRequest = false;
        if ([url.absoluteString hasSuffix:@".glwebp"]) {
            newURL = [[NSURL alloc]initWithString:[url.absoluteString stringByReplacingOccurrencesOfString:@".glwebp" withString:@".webp"]];
            isGLRequest = true;
        }
        ...
        if (isGLRequest){
            [request setValue:@"1" forHTTPHeaderField:@"webpNotLoadByCachingProtocol"];
        }
