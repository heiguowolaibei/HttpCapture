...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"小主，没有更多了哦";
...
NSString *const MJRefreshHeaderStatePullingText = @"松开立即更新";
NSString *const MJRefreshHeaderStateRefreshingText = @"正在更新...";

NSString *const MJRefreshFooterStateIdleText = @"点击加载更多";
NSString *const MJRefreshFooterStateRefreshingText = @"加载中...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"小主，没有更多了哦";